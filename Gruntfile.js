module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        config: {
            ...
            pagesDir : '<%= config.srcFolder %>/pages'
        },
        ...
        'handlebarslayouts': {
            templates: {
                files: {
                    '<%= config.distFolder %>/*.html': '<%= config.pagesDir %>/*.hbs'
                },
                options: {
                    partials: [
                        '<%= config.pagesDir %>/partials/*.hbs'
                    ],
                    context: {
        ...
        watch: {
            templates: {
                files: ['<%= config.pagesDir %>/*.hbs', '<%= config.pagesDir %>/partials/*.hbs'],
