...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modelsAppState = __webpack_require__(212);
	...
	function renderApp() {
	  ...
	  function appLayout() {
	    return _mithril2['default'].component(_componentsAppLayout2['default'], _extends({
	      ...
	      widgets: _modelsAppState2['default'].widgets
	    }, adapter), []);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashpanel = __webpack_require__(208);
	
	var _dashpanel2 = _interopRequireDefault(_dashpanel);
	    ...
	    children: [_mithril2['default'].component(_logo2['default'], ctrl, []), _mithril2['default'].component(_sidebar2['default'], ctrl, []), {
	      ...
	      children: [_mithril2['default'].component(_header2['default'], ctrl, []), {
	        ...
	        children: [{
	          ...
	          children: ['Dashboard ', {
	            tag: 'small',
	            children: ['Statistics and more']
	          }],
	          attrs: {
	            'class': 'page-title'
	          }
	        }, _mithril2['default'].component(_dashpanel2['default'], ctrl, []), _mithril2['default'].component(_chat2['default'], ctrl, [])],
	        attrs: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sideNavPanelsForms = __webpack_require__(198);
	
	var _sideNavPanelsForms2 = _interopRequireDefault(_sideNavPanelsForms);
	
	var _sideNavPanelsStats = __webpack_require__(199);
	
	var _sideNavPanelsStats2 = _interopRequireDefault(_sideNavPanelsStats);
	
	var _sideNavPanelsComponents = __webpack_require__(200);
	
	var _sideNavPanelsComponents2 = _interopRequireDefault(_sideNavPanelsComponents);
	
	var _sideNavPanelsSpecial = __webpack_require__(201);
	
	var _sideNavPanelsSpecial2 = _interopRequireDefault(_sideNavPanelsSpecial);
	
	var _sideNavPanelsTables = __webpack_require__(202);
	
	var _sideNavPanelsTables2 = _interopRequireDefault(_sideNavPanelsTables);
	
	var _sideNavPanelsUi = __webpack_require__(203);
	
	var _sideNavPanelsUi2 = _interopRequireDefault(_sideNavPanelsUi);
	
	var _sideNavPanelsWidgets = __webpack_require__(204);
	
	var _sideNavPanelsWidgets2 = _interopRequireDefault(_sideNavPanelsWidgets);
	
	var _sideNavPanelsMenus = __webpack_require__(205);
	
	var _sideNavPanelsMenus2 = _interopRequireDefault(_sideNavPanelsMenus);
	...
	function view(ctrl) {
	  return {
	    ...
	    }, _mithril2['default'].component(_sideNavPanelsUi2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsWidgets2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsComponents2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsForms2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsTables2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsStats2['default'], {}, []), _mithril2['default'].component(_sideNavPanelsSpecial2['default'], {}, []), {
	      tag: 'li',
	      children: [{
	        tag: 'a',
	        children: [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Forms = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stats = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Components = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Special = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tables = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UI = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widgets = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menus = { controller: controller, view: view };
	    ...
	    return {
	        ...
	        children: [{
	            ...
	            children: [{
	                ...
	                attrs: {
	                    'class': 'notifications pull-right hidden-sm'
	                }
	            }],
	            attrs: {
	                'class': 'navbar'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _widgetControls = __webpack_require__(209);
	
	var _widgetControls2 = _interopRequireDefault(_widgetControls);
	  ...
	  return {
	    ...
	    children: [{
	      ...
	      children: [{
	        ...
	        children: [{
	          tag: 'h4',
	          children: [cfg.header.capitalize()]
	        }, _mithril2['default'].component(_widgetControls2['default'], {}, [])]
	      }, {
	        tag: 'div',
	        children: [],
	        attrs: {
	    ...
	    attrs: {
	      className: cfg.grid + " widget-container"
	    }
	  };
	}
	...
	function view(ctrl) {
	  ...
	  return {
	    tag: 'div',
	    children: [widgets().map(buildWidget)],
	    attrs: {
	      className: 'row'
	    }
	  };
	...
	var DashPanel = { controller: controller, view: view };
	
	exports['default'] = DashPanel;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WidgetControls = { controller: controller, view: view };
	
	exports["default"] = WidgetControls;
	module.exports = exports["default"];
	  ...
	  return {
	    ...
	    children: [{
	      ...
	      children: [{
	        ...
	        children: [{
	          tag: 'div',
	          children: [_mithril2['default'].component(_log2['default'], ctrl, []), {
	            tag: 'footer',
	            children: [{
	              tag: 'form',
	              children: [{
	                ...
	                children: [{
	                  ...
	                  attrs: {
	                    ...
	                    autocomplete: 'off',
	                    onchange: _mithril2['default'].withAttr('value', ctrl.message),
	                    value: ctrl.message(),
	                ...
	                children: [{
	                  ...
	                  attrs: {
	                    type: 'submit',
	                    id: 'new-message-btn',
	                    className: 'entry__send btn btn-transparent btn-block'
	                  }
	                }],
	                attrs: {
	                  'class': 'col-xs-3'
	    ...
	    attrs: {
	      className: 'col-md-4 widget-container'
	    }
	  };
	}
	
	var Chat = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function view(ctrl) {
	  ...
	  return {
	    tag: "div",
	    children: [messages().map(buildMessage)],
	    attrs: {
	      id: "chat-messages",
	      className: "log chat-messages"
	    }
	  };
	}
	
	var Log = { controller: controller, view: view };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _widgets = _mithril2['default'].prop([{
	  header: 'Visits',
	  widget: 'visits',
	  grid: 'col-md-8'
	}, {
